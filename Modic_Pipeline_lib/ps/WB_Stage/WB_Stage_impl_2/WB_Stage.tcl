if { ![project_exists {WB_Stage}] } {
     project_new {WB_Stage}
} else {
     project_open {WB_Stage}
}
set_project_settings -cmp {WB_Stage}
if { ![project_settings_exist -sim WB_Stage] } {
        set_project_settings -sim WB_Stage
}
set_global_assignment -section_id {WB_Stage} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {WB_Stage.vqm}
...
if { [file exists {WB_Stage_altera.prop}] } {
  source WB_Stage_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {WB_Stage} -name {DEVICE} {EP2C70F896I8}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {WB_Stage_pnr_constraints.sdc}
