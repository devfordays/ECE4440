if { ![project_exists {Decode_Dest_MUX}] } {
     project_new {Decode_Dest_MUX}
} else {
     project_open {Decode_Dest_MUX}
}
set_project_settings -cmp {Decode_Dest_MUX}
if { ![project_settings_exist -sim Decode_Dest_MUX] } {
        set_project_settings -sim Decode_Dest_MUX
}
set_global_assignment -section_id {Decode_Dest_MUX} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {Decode_Dest_MUX.vqm}
...
if { [file exists {Decode_Dest_MUX_altera.prop}] } {
  source Decode_Dest_MUX_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {Decode_Dest_MUX} -name {DEVICE} {EP2C70F896I8}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {Decode_Dest_MUX_pnr_constraints.sdc}
