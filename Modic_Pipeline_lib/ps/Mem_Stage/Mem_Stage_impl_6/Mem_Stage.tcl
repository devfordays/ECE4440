if { ![project_exists {Mem_Stage}] } {
     project_new {Mem_Stage}
} else {
     project_open {Mem_Stage}
}
set_project_settings -cmp {Mem_Stage}
if { ![project_settings_exist -sim Mem_Stage] } {
        set_project_settings -sim Mem_Stage
}
set_global_assignment -section_id {Mem_Stage} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {Mem_Stage.vqm}
...
if { [file exists {Mem_Stage_altera.prop}] } {
  source Mem_Stage_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {Mem_Stage} -name {DEVICE} {EP2C70F896I8}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {Mem_Stage_pnr_constraints.sdc}
