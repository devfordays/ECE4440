if { ![project_exists {Decode_Controller}] } {
     project_new {Decode_Controller}
} else {
     project_open {Decode_Controller}
}
set_project_settings -cmp {Decode_Controller}
if { ![project_settings_exist -sim Decode_Controller] } {
        set_project_settings -sim Decode_Controller
}
set_global_assignment -section_id {Decode_Controller} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {Decode_Controller.vqm}
...
if { [file exists {Decode_Controller_altera.prop}] } {
  source Decode_Controller_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {Decode_Controller} -name {DEVICE} {EP2C70F896I8}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {Decode_Controller_pnr_constraints.sdc}
