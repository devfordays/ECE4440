if { ![project_exists {Register_Tracker}] } {
     project_new {Register_Tracker}
} else {
     project_open {Register_Tracker}
}
set_project_settings -cmp {Register_Tracker}
if { ![project_settings_exist -sim Register_Tracker] } {
        set_project_settings -sim Register_Tracker
}
set_global_assignment -section_id {Register_Tracker} -name {EDA_DESIGN_ENTRY_SYNTHESIS_TOOL} {PRECISION SYNTHESIS}
set_global_assignment -name {VQM_FILE} {Register_Tracker.vqm}
...
if { [file exists {Register_Tracker_altera.prop}] } {
  source Register_Tracker_altera.prop
}
set_global_assignment -name {FAMILY} {CYCLONE II}
set_global_assignment -section_id {Register_Tracker} -name {DEVICE} {EP2C70F896I8}
set_global_assignment -name {PROJECT_SHOW_ENTITY_NAME} {OFF}
set_global_assignment -name {SDC_FILE} {Register_Tracker_pnr_constraints.sdc}
